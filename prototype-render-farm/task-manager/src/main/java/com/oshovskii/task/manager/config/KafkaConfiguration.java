package com.oshovskii.task.manager.config;
...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, TaskDto> consumerFactory(KafkaProperties kafkaProperties) {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TaskDto> kafkaListenerContainerFactory(KafkaProperties kafkaProperties) {
